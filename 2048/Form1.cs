        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            for (i = 0; i <= n; i++)
            {
                for (j = 0; j <= n; j++)
                {
                    ...
                    buttonMatrix[i, j].Anchor = AnchorStyles.None;
                    buttonMatrix[i, j].FlatStyle = FlatStyle.Flat;
                    buttonMatrix[i, j].Location = new Point(sus, jos);
                    buttonMatrix[i, j].Font = new Font("Segoe UI", 16, FontStyle.Bold);
                    buttonMatrix[i, j].Visible = false;
        ...
        private void changecolor()
        {
            for (int i = 0; i <= n; i++)
            {
                for (int j = 0; j <= n; j++)
                {
                    ...
                    {
                        buttonMatrix[i, j].BackColor = Color.Goldenrod;
                    }
                    if (buttonMatrix[i, j].Text == "2048")
                    {
                        buttonMatrix[i, j].BackColor = Color.Gold;
                    }
                }
            }
        }
